...
class OpenMailAppPlus {
  ...
  static const MethodChannel _channel = MethodChannel('open_mail_app_plus');
        ...
        for (var app in mailApps)
          SimpleDialogOption(
            ...
            onPressed: () {
              ...
              if (content != null) {
                OpenMailAppPlus.composeNewEmailInSpecificMailApp(
                  mailApp: app,
                  emailContent: content,
                );
              } else {
                OpenMailAppPlus.openSpecificMailApp(app);
              }
...
class MailApp {
  ...
  String? composeLaunchScheme(EmailContent content) {
    if (OpenMailAppPlus._isAndroid) {
      return content.toJson();
    } else if (OpenMailAppPlus._isIOS) {
